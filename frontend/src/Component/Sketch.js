		...
		return (
			...
			<div className="Sketch">
				...
				<p className="Sketch-description">
					Tiru Aksara Jawa Disini
				</p>
				<div>
					<div className="Sketch-pad" ref={this.renderRef}></div>
					<button
						ref={this.classifyRef}
						onClick={this.classifyImage.bind(this)}
					>
						Cek Jawaban
					</button>
					<button ref={this.resetRef} onClick={this.resetCanvas.bind(this)}>
						Hapus
					</button>
				</div>
			</div>
